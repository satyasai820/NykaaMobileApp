    ...
    return(
        ...
        <Imports.ScrollView>
         <Imports.View style={styles.container}>
                <Imports.View>
                    <Imports.Text style={styles.text}>Categories</Imports.Text>
                </Imports.View>
                <Imports.View>
                    {namesData.map((item, index) => (
                        
                            <Imports.TouchableOpacity style={styles.innerView} key={index} 
                            onPress={() => naviagtion.navigate('Makeup')
                                ...
                                <Imports.View style={styles.imageView}>
                                    <Imports.Image style={{ width: 40, height: 40, borderRadius: 50 }} source={{ uri: item.img }} />
                                </Imports.View>
