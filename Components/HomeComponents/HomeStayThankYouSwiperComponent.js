...
const HomeStayThankYouSwiperComponent = () => {
    ...
    return(
        ...
        <Imports.View style={styles.container}>
            <Imports.View>
                <Imports.Image style={{width:400, height:140}} source={{uri:'https://images-static.nykaa.com/uploads/02f9b0a2-2d25-4888-b6cf-a9fdfa80f790.jpg?tr=cm-pad_resize,w-1200'}} />
            </Imports.View>
            <Imports.View>
