...
const AccountScreen = () => {
    ...
    const textData = [{ m1: 'Order', m2: 'Check your orders status (track, return, cancle etc)', icon: 'tablet-portrait-outline' }, { m1: 'MyCoupons', m2: 'Browse coupons to get discount on Nykaa', icon: 'ticket-outline' }, { m1: 'Wallet', m2: 'Check your Nykaa Wallet balance', icon: 'card-outline' }, { m1: 'Wishlist', m2: 'Buy from items saved in Wishlist', icon: 'heart-outline' }, { m1: 'Loyalty Program', m2: 'Shop for ₹2000 to be become a member', icon: 'school-outline' }, { m1: 'Beauty Portflio', m2: 'Personalise your Nykaa App experience', icon: 'sparkles-sharp' }, { m1: 'Help and Support', m2: 'Get help for your account or orders', icon: 'help-circle-outline' }, { m1: 'Addresses', m2: 'Manage your saved Saved address', icon: 'id-card-outline' }, { m1: 'Payment Methods', m2: 'Manage your saved payment methods ', icon: 'browsers-outline' }, { m1: 'Profile', m2: 'Edit/update your profike details & more', icon: 'person-outline' },]
            ...
            <View style={styles.mainContainer}>
                <View style={styles.container}>
                    ...
                    {textData.map((item, index) => {
                        ...
                        return (
                            <TouchableOpacity onPress={handleNavigeFunction} key={index} style={{
